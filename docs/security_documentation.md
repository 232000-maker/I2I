...
- **Verify-then-Parse:** The protocol mandates MAC verification *before* JSON parsing. This mitigates Cryptographic DoS attacks where an attacker sends massive malformed JSON to exhaust CPU/RAM.
